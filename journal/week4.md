...
This week was hard, but very cool to learn every of the concepts to create a good direct conection between flask and a production db as postgres using RDS, also the knowledge to create layers in a lambda, and generating this lambda to listen when a new user is registered was great as well.

![Lambda Post Confirmation](assets/proof-of-lambda.png)

![RDS](assets/proof-of-rds.png)

### All from here are the journal tips from Andrew
